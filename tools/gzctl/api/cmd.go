...
import (
	"github.com/project-joey/go-zero/tools/gzctl/api/apigen"
	"github.com/project-joey/go-zero/tools/gzctl/api/dartgen"
	"github.com/project-joey/go-zero/tools/gzctl/api/docgen"
	"github.com/project-joey/go-zero/tools/gzctl/api/format"
	"github.com/project-joey/go-zero/tools/gzctl/api/gogen"
	"github.com/project-joey/go-zero/tools/gzctl/api/javagen"
	"github.com/project-joey/go-zero/tools/gzctl/api/ktgen"
	"github.com/project-joey/go-zero/tools/gzctl/api/new"
	"github.com/project-joey/go-zero/tools/gzctl/api/tsgen"
	"github.com/project-joey/go-zero/tools/gzctl/api/validate"
